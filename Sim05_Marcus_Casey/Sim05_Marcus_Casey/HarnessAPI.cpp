...
string scheduleType;
	if (configurationData.getCpuScheduleCode() == 0) {
		scheduleType = "FIFO";
	} else if (configurationData.getCpuScheduleCode() == 1) {
		scheduleType = "PS";
	} else if (configurationData.getCpuScheduleCode() == 2) {
		scheduleType = "SJF";
	} else if (configurationData.getCpuScheduleCode() == 3) {
		scheduleType = "STR";
	} else if (configurationData.getCpuScheduleCode() == 4) {
		scheduleType = "RR";
	}
		return;
	}
	...
	cout << "Processor Quantum Number = " << configurationData.getProcessorQuantumNumber() << endl;
	...
	cout << "Memory Block Size = " << configurationData.returnMemBlockAmt() << " kbytes" << endl;
	cout << "Projector Quantity = " << configurationData.returnProjAmount() << endl;
	cout << "Hard Drive Quantity = " << configurationData.returnHdAmt() << endl;
	cout << "Logged to: ";
