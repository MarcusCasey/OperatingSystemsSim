...
// Parameterized constructor for MetaDataAPI
...
// assign metaType descriptionInterpreter to descriptionInputLocationMain 
...
// Return the meta descriptionInterpreter  
...
void MetaDataAPI::setData(char metaLocationMain, string descriptionInput, int totalAmountOfCycles, int returnTimeElapsedTotalLocationM) {
	descriptionInput = metaLocationMain;
	metaDataWord = descriptionInput;
	amtCyclesTotal = totalAmountOfCycles;
	amtTotalTimeRan = returnTimeElapsedTotalLocationM;
}

	
void MetaDataAPI::print() {
	cout << descriptionInput << "{" << metaDataWord << "}" << amtCyclesTotal << "-" << amtTotalTimeRan;
}
